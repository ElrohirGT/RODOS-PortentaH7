...
void EXTI0_IRQHandler() {
    if(extInterruptLines[0]) { extInterruptLines[0]->EXTIRQHandler(); }
...
void EXTI1_IRQHandler() {
    if(extInterruptLines[1]) { extInterruptLines[1]->EXTIRQHandler(); }
...
void EXTI2_IRQHandler() {
    if(extInterruptLines[2]) { extInterruptLines[2]->EXTIRQHandler(); }
...
void EXTI3_IRQHandler() {
    if(extInterruptLines[3]) { extInterruptLines[3]->EXTIRQHandler(); }
...
void EXTI4_IRQHandler() {
    if(extInterruptLines[4]) { extInterruptLines[4]->EXTIRQHandler(); }
...
void EXTI9_5_IRQHandler() {
    ...
    for(int i = 5; i <= 9; i++) {
        if(((pending >> i) & 0x01) && extInterruptLines[i]) { extInterruptLines[i]->EXTIRQHandler(); }
    }
